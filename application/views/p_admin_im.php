            ...
            <div class="box-body">
              ...
              <table id="status" class="table table-condensed table-striped">
                ...
                <tr>
                    ...
                    <td><a href="<?php echo base_url(); ?>index.php/admin/update_item/<?php echo $row->item_id; ?>"> Edit</a></td>
                    <td><button type="button" class="btn btn-block btn-xs delete_item" id="<?php echo $row->item_id; ?>"> Delete</button></td>
                </tr>
				<?php }
					}else{?>
                <tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
	  ...
	  <form method="post" action="<?php echo base_url()?>index.php/admin/form_validation2">	  
		...
		<br>
        <div class="form-group">
            <span class="input-group-addon">Register Person</span>
            <input type="text" class="form-control" name="r_agent" placeholder="Register Person">
        </div>
      </div>
